...
namespace Microsoft.Azure.Commands.Synapse.Models
{
    public class SynapseAnalyticsManagementClient
    {
            ...
            IntegrationRuntimeResource integrationRuntime)
        {
            ...
            var response = await _synapseManagementClient.IntegrationRuntimes.StartWithHttpMessagesAsync(
                resourceGroupName,
                workspaceName,
                integrationRuntimeName);
            ...
            try
            {
                var result = await _synapseManagementClient.GetLongRunningOperationResultAsync(response, null, default(CancellationToken));
            ...
            string integrationRuntimeName)
        {
            ...
            var response = await _synapseManagementClient.IntegrationRuntimes.StopWithHttpMessagesAsync(
                resourceGroupName,
                workspaceName,
                integrationRuntimeName);
            ...
            try
            {
                await _synapseManagementClient.GetLongRunningOperationResultAsync(response, null, default(CancellationToken));
            }
            catch (Exception e)
            {
                throw RethrowLongingRunningException(e);
